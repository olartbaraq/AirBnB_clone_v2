...
class DBStorage():
    """Declares a class for database engine"""
    __engine = None
    __session = None

    def __init__(self):
        """instantiation of first instance"""
        con_txt = 'mysql+mysqldb://{}:{}@{}:3306/{}'
        ...
        engine_txt = con_txt.format(user, password, host, database)
        engine = create_engine(engine_txt, pool_pre_ping=True)
